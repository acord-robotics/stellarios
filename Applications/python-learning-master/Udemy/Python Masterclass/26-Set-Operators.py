# 26 - Set Operators
https://www.udemy.com/course/python-masterclass-for-beginners/learn/lecture/13309342#content
...
Line 44: Tuples
Line 58: Set Stuff
Line 94 - List Operators
Line 144 - Tuple Operators
Line 165 - Set Operators
"""
...
mySet = {"Apple", "Google", "Microsoft"}
myOtherSet = {"Apple", "Facebook"}
result = mySet.union(myOtherSet) # methods + comp sci + s2rd - midgardiaco2s/miydlioans - it's coming together! + spaceX + sci-fi

print(result) # each value is only there once (this is for the duplicates BETWEEN the sets, not INSIDE the sets)

intersection = mySet.intersection(myOtherSet)

print(intersection)

differenceBetweenSets = mySet.difference(myOtherSet) # this is for things in mySet that aren't in mOS, not the other way around, not both

# Other operators seen in tuples & lists may work in sets
...
# Data Structures Quiz
answers = [4, "insert", "d", "a,b,c", "error (tuples don't support indexing)"]