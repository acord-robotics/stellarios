function Initialize()
	...
	REFERENCE  = {
		...
		scout={name="Scout",bangs='[!ActivateConfig "NXT-OS\\Scout" "Scout.ini"]',icon="Scout"},
		overlaylauncher={name="Overlay Launcher",bangs='[!ActivateConfig NXT-OS\\Overlay Overlay-Launcher.ini]',icon="OverlayLauncher"},
		overlaywidgets={name="Overlay Widgets",bangs='[!ActivateConfig NXT-OS\\Overlay Overlay-Widgets.ini]',icon="OverlayWidgets"},
...
function SetOptions() --Sets the options of the icons based of the reference table.
	...
	SKIN:Bang("!SetOption","Icon1","X","(((#Window.Width#-"..size..")/2)+100)")
	SKIN:Bang("!Update")
