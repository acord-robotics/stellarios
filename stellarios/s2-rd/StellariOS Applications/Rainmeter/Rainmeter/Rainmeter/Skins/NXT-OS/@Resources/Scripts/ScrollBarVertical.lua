active = false
function call(name,y,posname)
	posmeasure = posname
	if posmeasure == nil or posmeasure == "" then posmeasure = 'Scroll.Pos' end
	SKIN:Bang("[!SetOption "..posmeasure.." Disabled 0][!Update]")
...
function unlock()
	SKIN:Bang("[!SetOption "..posmeasure.." Disabled 1][!Update]")
