...
function Draw()
	...
	SKIN:Bang("!SetOption","Window.Inner.Box","H",size-97)
	SKIN:Bang("!SetOption","Window.Menu","H",size-97)
	SKIN:Bang("!SetOption","DarkBGSection","H",(size-101))
	SKIN:Bang("!Update")
end
