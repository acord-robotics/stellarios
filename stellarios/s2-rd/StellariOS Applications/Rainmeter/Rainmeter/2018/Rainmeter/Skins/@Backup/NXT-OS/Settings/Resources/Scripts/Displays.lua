function Initialize()
	...
	local DDBangs2= '[!Move #PWORKAREAX# #PWORKAREAY# NXT-OS\\Dock][!Move #PWORKAREAX# #PWORKAREAY# NXT-OS\\Top][!Move (#PWORKAREAX#+#PWORKAREAWIDTH#-288) #PWORKAREAY# NXT-OS\\Drawer][!Move (#PSCREENAREAX#+(#PSCREENAREAWIDTH#-600)/2) (#PSCREENAREAY#+(#PSCREENAREAHEIGHT#-600)/2) NXT-OS\\CenterClock][!Move #PWORKAREAX# (#PWORKAREAY#+#PWORKAREAHEIGHT#-176) NXT-OS\\GameDrawer][!RefreshGroup NXTDesktop]|'

	for k,v in pairs(actual) do
		DDList1 = DDList1 .. '|Monitor '..k..': #SCREENAREAWIDTH@'..k..'#x#SCREENAREAHEIGHT@'..k..'#'
		DDBangs1 = DDBangs1 .. '|[!CommandMeasure "Displays" "Save('..k..')"]'
		DDBangs2 = DDBangs2 .. '|[!Move #WORKAREAX@'..k..'# #WORKAREAY@'..k..'# NXT-OS\\Dock][!Move #WORKAREAX@'..k..'# #WORKAREAY@'..k..'# NXT-OS\\Top][!Move (#WORKAREAX@'..k..'#+#WORKAREAWIDTH@'..k..'#-288) #WORKAREAY@'..k..'# NXT-OS\\Drawer][!Move (#SCREENAREAX@'..k..'#+(#SCREENAREAWIDTH@'..k..'#-600)/2) (#SCREENAREAY@'..k..'#+(#SCREENAREAHEIGHT@'..k..'#-600)/2) NXT-OS\\CenterClock][!Move #WORKAREAX@'..k..'# (#WORKAREAY@'..k..'#+#WORKAREAHEIGHT@'..k..'#-176) NXT-OS\\GameDrawer][!RefreshGroup NXTDesktop]'
	end
